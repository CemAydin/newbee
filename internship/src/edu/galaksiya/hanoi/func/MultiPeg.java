...
public class MultiPeg {
	...
	public static void main(String[] args) {
		...
		allWrite(source, immediate1, immediate2, dest);// ilk değerler ekrana
														// yazdırılır
		move(n, source, immediate1, immediate2, dest);
		allWrite(source, immediate1, immediate2, dest);// son değerler ekrana
														// yazdırılır
	...
	public static void assign(int[] src, int[] dst) {// a disc move
		...
		if (b == 0) {
			System.out.println("\n" + src[a - 1] + "degeri" + (dst[b])
					+ " üzerine tasindi");
		} else {
			System.out.println("\n" + src[a - 1] + "degeri" + (dst[b - 1])
					+ " üzerine tasindi");
		}
